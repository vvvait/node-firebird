...
const
    ...
    ISOLATION_READ_COMMITED_NOWAIT = [isc_tpb_version3, isc_tpb_write, isc_tpb_nowait, isc_tpb_read_committed, isc_tpb_no_rec_version],
...
exports.ISOLATION_READ_COMMITED_NOWAIT = ISOLATION_READ_COMMITED_NOWAIT;
...
Connection.prototype.startTransaction = function(isolation, callback) {
    ...
    blr.addBytes(isolation || ISOLATION_READ_COMMITED_NOWAIT);
