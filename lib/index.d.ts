...
declare module 'node-firebird' {
    ...
    export interface Transaction {
        ...
        execute(query: string, params: any[], callback: QueryCallback, custom?: any): void;
        sequentially(query: string, params: any[], rowCallback: SequentialCallback, callback: SimpleCallback, asArray?: boolean): Database;
    ...
    export interface ServiceManager {
        ...
        nbackup(options: NBackupOptions, callback: ReadableCallback): void;
        restore(options: RestoreOptions, callback: ReadableCallback): void;
        nrestore(options: NRestoreOptions, callback: Function): void;
